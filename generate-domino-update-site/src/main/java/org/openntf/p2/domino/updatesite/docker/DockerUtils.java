...
public class DockerUtils {
    ...
    public static void makeSureImageExists(DockerClient dockerClient, String imageId) throws DockerFileManagerException {
        try {
            dockerClient
    ...
    public static String createContainer(DockerClient dockerClient, String imageId) throws DockerFileManagerException {
        makeSureImageExists(dockerClient, imageId);
